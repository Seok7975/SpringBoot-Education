...
/*
@RestponseBody + Controller 와 같은 형태로 Rest API를 만들기 위한 컨트롤러에서
주로 사용된다. 내부 메서드에서 반환되는 값은 즉시 웹 브라우저에 출력된다. 
(일반적인 컨트롤러에서는 반환값이 View의 경로가 된다)
 */
@RestController
public class MyRestController {
	...
	/*
	JSON 배열
	: 배열은 List와 동일한 구조를 가진다. 특정 Key없이 인덱스로 접근한다. 
	 */
	...
	//JSON배열이지만 객체를 인자로 가진다. 게시판의 목록에서 많이 사용된다. 
