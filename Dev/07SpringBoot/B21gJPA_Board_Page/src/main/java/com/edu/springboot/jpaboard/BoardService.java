...
public class BoardService {
	...
	//목록(페이징)
	public Page<BoardEntity> selectListPage(Pageable pageable){
		Page<BoardEntity> boardRows = boardRepository.findAll(pageable);
		return boardRows;
	}
	//목록(페이징+검색)	
	public Page<BoardEntity> selectListPageSearch(String search, Pageable pageable){ 
		Page<BoardEntity> boardRows = boardRepository.findByTitleLike(search, pageable);
		return boardRows;
	}
